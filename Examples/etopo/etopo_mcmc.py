...
class etopo_MCMC():
	...
	def sampler(self):
		...
		self.viewGrid('real', 0 , 1, 2.e-6, width=1000, height=1000, zmin=-10, zmax=600, zData=real_elev, title='Real Elevation')
		...
		erod = np.random.uniform(1.e-6,4.e-6)
...
def main():
	...
	etopo_mcmc = etopo_MCMC(muted, simtime, samples, final_elev, filename, xmlinput, erodlimits, rainlimits, mlimit, nlimit, run_nb_str)
	[pos_rain, pos_erod, pos_m, pos_n, pos_tau, pos_rmse, pos_likl, accept_ratio, accepted_count] = etopo_mcmc.sampler()
